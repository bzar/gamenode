if(typeof require !== "undefined") {
    var Vec2D = require("./vec2d").Vec2D,
        vecUtils = require("./vec2dUtils");
}

var ACCELERATION = 300.0;
var TURN_RATE = 3.0
var SHOT_VELOCITY = 600.0;
var SHOT_IMPULSE = 50.0;
var SHOT_LIFE = 2;
var MAX_SHOTS = 5;
...
Shot.prototype.interact = function() {
    var players = this.player.game.players;
    for(var i = 0; i < players.length; ++i) {
        ...
        if(vecUtils.circleIntersection(this.position, 3.0, player.position, 15.0)) {
            player.velocity.addi(this.velocity.subtracti(player.velocity).unit().scalei(SHOT_IMPULSE));
            return true;
        }
    }
